...
import QRImage from "../../assets/img/Qrcode 1.png";
import googlePlayImage from "../../assets/img/googleplay.png";
import AppStoreImage from "../../assets/img/AppStore.png";

const Footer = () => {
  return (
    <footer style={{ backgroundColor: "#000000", color: "#ffffff", marginTop: '40px' }}>
      <div
        className="d-flex justify-content-evenly flex-wrap footer-div"
        style={{ margin: "30px 0px 0px 35px", padding: "40px 0px" }}
      >
        <div>
          <h2 className="mb-3">Exclusive</h2>
          <h4 className="my-3">Subscribe</h4>
        ...
        <div>
          ...
          <ul className="footer-ul">
            <li>
              ...
              <br /> NY 12345,United States.
            </li>
            <li>mahdiayyad97@gmail.com</li>
      ...
      <div
        style={{ borderBottom: "1px solid rgb(28, 28, 28)", marginTop: "30px" }}
      ></div>
      <div className="py-2 text-center">
        ...
        &nbsp;
        <span>Copyright Mahdi Ayyad 2024. All right reserved</span>
      </div>
    </footer>
  );
};
