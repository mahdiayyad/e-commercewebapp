        ...
        <div className="col-12">
          <div className="service-container">
            <div className="text-center service">
              ...
              <p className="m-0 mt-1" style={{ fontSize: "12px" }}>
